    ...
    >
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-10 items-center top-24 self-start max-w-xs lg:max-w-sm md:w-full">
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0  w-[2px] bg-gradient-to-t from-[#a855f7] via-[#f472b6] to-transparent from-[0%] via-[10%] rounded-full"
          />
        </div>
      </div>
    </div>
