...
export function CustomPre({
  ...
  return (
    <>
      {mounted && dataLanguage && <div data-rehype-pretty-code-title>{dataLanguage}</div>}
      <pre {...rest} ref={preRef} className="relative">
        {mounted && (
          <button
            className='absolute right-2 top-2 grid rounded-md p-2 text-gray-600 dark:text-gray-300 border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors'
