...
export interface StaggeredMenuProps {
  ...
  /** When true, behaves like a sticky navbar that stays at the top */
  sticky?: boolean;
  onMenuOpen?: () => void;
  onMenuClose?: () => void;
}
  ...
  return (
    <div className="sm-scope w-full h-full">
      <div
        className={
          (className ? className + " " : "") +
          `staggered-menu-wrapper relative w-full ${
            sticky ? "h-auto" : "h-full"
          } z-40`
        }
        style={
          accentColor
      ...
      >
        <div
          ...
          } top-0 right-0 bottom-0 pointer-events-none z-[5]`}
          aria-hidden="true"
        >
          {(() => {
            const raw =
        ...
        <header
          className={`staggered-menu-header ${
            sticky ? "sticky top-0" : "absolute top-0"
          } left-0 w-full flex items-center justify-between p-[2em] bg-transparent pointer-events-none ${
            sticky ? "z-50" : "z-20"
          }`}
        ...
        >
          ...
          >
            <img
              src={logoUrl || "/public/favicon1.png"}
              alt="Logo"
        ...
        <aside
          ...
          className={`staggered-menu-panel ${
            sticky ? "fixed" : "absolute"
          } top-0 right-0 h-full bg-white flex flex-col p-[6em_2em_2em_2em] overflow-y-auto z-10 backdrop-blur-[12px]`}
...
.sm-scope .staggered-menu-wrapper[data-sticky] { height: auto; }
.sm-scope .staggered-menu-header { position: absolute; top: 0; left: 0; width: 100%; display: flex; align-items: center; justify-content: space-between; padding: 2em; background: transparent; pointer-events: none; z-index: 20; }
.sm-scope [data-sticky] .staggered-menu-header { position: sticky; top: 0; }
...
.sm-scope [data-sticky] .staggered-menu-panel { position: fixed; }
.sm-scope [data-position='left'] .staggered-menu-panel { right: auto; left: 0; }
.sm-scope .sm-prelayers { position: absolute; top: 0; right: 0; bottom: 0; width: clamp(260px, 38vw, 420px); pointer-events: none; z-index: 5; }
.sm-scope [data-sticky] .sm-prelayers { position: fixed; }
