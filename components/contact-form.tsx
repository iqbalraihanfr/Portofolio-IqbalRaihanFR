...
import { Mail, Phone, MapPin, Send, Linkedin, Clock, MessageCircle } from "lucide-react"
...
export function ContactForm() {
  ...
  return (
    <section className="py-32 relative overflow-hidden">
      {/* Background Elements */}
      <div className="absolute inset-0 bg-linear-to-b from-transparent via-purple-50/30 to-transparent dark:via-purple-900/10" />
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        >
          ...
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 bg-linear-to-r from-gray-900 via-purple-800 to-pink-800 dark:from-white dark:via-purple-200 dark:to-pink-200 bg-clip-text text-transparent">
            Get In Touch
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 max-w-7xl mx-auto">
          ...
          >
            <motion.div variants={itemVariants}>
              <h3 className="text-3xl font-bold mb-6 bg-linear-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">
                Let's Connect
              </h3>
            ...
            <motion.div variants={itemVariants} className="space-y-6">
              {contactInfo.map((info, index) => (
                <motion.div key={index} whileHover={{ x: 10, scale: 1.02 }} className="group">
                  <a
                    href={info.href}
                    className="flex items-center space-x-6 p-6 bg-white/60 dark:bg-gray-800/60 backdrop-blur-xl rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 border border-transparent hover:border-purple-200 dark:hover:border-purple-800"
                  ...
                  >
                    ...
                    <div>
                      <p className="font-bold text-lg text-gray-800 dark:text-gray-200 group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors duration-300">
                        {info.label}
                      </p>
            ...
            <motion.div variants={itemVariants}>
              <Card className="bg-linear-to-r from-blue-50 via-purple-50 to-pink-50 dark:from-blue-900/20 dark:via-purple-900/20 dark:to-pink-900/20">
